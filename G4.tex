...
\usepackage{mdframed} % Page spanning boxes
\usepackage{longtable, tabularx} % Multipage Table
\usepackage{url}
...
\begin{center}
\fbox{\includegraphics[scale=0.75]{Screens/ThinkAloudScript.pdf}}
\end{center}
...
\pagebreak
\begin{center}
{\Large State 2 (Click "okay" - Screen 3)}
\end{center}
...
\begin{center}
{ \Large State 3 (Click ''Add New'' - Screen 5)}
\end{center}
